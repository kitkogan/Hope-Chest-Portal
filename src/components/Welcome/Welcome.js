  ...
  render() {
    return (
      <div className="welcomePage">
        ...
        <h2>Hope Chest for Breast Cancer Foundation is excited to work with you and together we will make an impact to better the lives of Minnesota Breast Cancer Patients.</h2>
        
        <h3>Cause Marketing </h3>
        <p>What is Cause Marketing?
        ...
        <p>Did you know… 86% of American's expect companies to do more than make a profit; address community issues. (Key statistics from Blackbaud)
        ...
        <li>We promote your program on our website, social media channels and newsletter.</li>
        <li>You have 100% control over your promotional program with Hope Chest. Some ideas include:</li>
        <li>Create a special package or event night and donate those proceeds. </li>
        <li>Create a "round up" program where extra change is donated.</li>
        <li>Donate a percentage of sales from your Hope Chest day.</li>
        <li>Throw a company party or mixer with a “cover fee” to give to Hope Chest.</li>
        </ul>
